...
const pegawai = {
    nama: "Egal Assegaf",
    jabatan: "Programmer Fullstack",
    umur: 23,
    hadir: function () {
        console.log(`Halo nama saya ${this.nama} jabatan saya ${this.jabatan} umur saya ${this.umur}`);
    }
}

// console.log(pegawai.nama);
// console.log(pegawai.umur);
...
const pegawai2 = {
    ...
    hitungGaji: function () {
        return this.gajiHarian * this.hariKerja;
    },

    //method untuk menampilkan data pegawai 
    tampilkanData: function () {
        console.log('Nama saya : ', this.nama)
        console.log('Jabatan saya : ', this.jabatan)
        console.log('Umur saya : ', this.umur)
        console.log('Total gaji saya : ', this.hitungGaji());
    }
}

const { nama, ...sisanya } = pegawai2;
